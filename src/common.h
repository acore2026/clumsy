...
#define CLUMSY_VERSION "1.1"
#define MSG_BUFSIZE 512
#define FILTER_BUFSIZE 1024
#define NAME_SIZE 16
#define MODULE_CNT 8
#define ICON_UPDATE_MS 200
#define UI_BINDING_MAX 96
#define UI_BINDING_KEY_SIZE 64
#define UI_BINDING_VALUE_SIZE 64
#define SCENARIO_MAX_COUNT 32
#define SCENARIO_NAME_SIZE 64
#define SCENARIO_OPTION_MAX 64
#define SCENARIO_KEY_SIZE 64
#define SCENARIO_VALUE_SIZE 128
#define REMOTE_BIND_SIZE 64
#define REMOTE_TOKEN_SIZE 128
#define WM_CLUMSY_REMOTE_COMMAND (WM_APP + 1)
...
typedef struct {
    char key[SCENARIO_KEY_SIZE];
    char value[SCENARIO_VALUE_SIZE];
} ScenarioOption;
...
typedef struct {
    ...
    UINT optionCount;
    ScenarioOption options[SCENARIO_OPTION_MAX];
} Scenario;

typedef struct {
    BOOL enabled;
    char bind[REMOTE_BIND_SIZE];
    unsigned short port;
    char token[REMOTE_TOKEN_SIZE];
} RemoteServerConfig;
